...
- `skills/stamic-skill/scripts/search_statamic_docs.sh` — helper to search a local docs mirror (optional; waits for in-progress updates; supports optional non-interactive `fzf` ranking with fallback).
